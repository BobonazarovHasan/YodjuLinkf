                            ...
                            <div className=" admin-cols col offset-2">
                                <div className={'cards'}>
                                                                ...
                                                                <div className="doc-col col-md-4">
                                                                    ...
                                                                    <div className="tap">
                                                                        ...
                                                                        <select className={'select form-control'}
                                                                                required>
                                                                            <option className={'opt'} value="">____
                                                                            </option>
                                                                    ...
                                                                    <div className="tap">
                                                                        ...
                                                                        <select className={'select form-control'}
                                                                                required>
                                                                            <option className={'opt'} value="">Yo`q
                                                                            </option>
                                                                            <option className={'opt'}
                                                                                    value="1">1-holat
                                                                            </option>
                                                            ...
                                                            <div className="doc-col col">
                                                                <div className="tap">
                                                                    ...
                                                                    <select className={'select form-control'} required>
                                                                        ...
                                                                        <option className={'opt'} value="man">IELTS
                                                                        </option>
                                                                        <option className={'opt'} value="man">TOPIC
                                                                        </option>
                                                                    </select>
                                                                    <hr/>
                                                                </div>
                                                            ...
                                                            <div className="doc-col col">
                                                                ...
                                                                <div className="tap">
                                                                    ...
                                                                    <select className={'select form-control'} required>
                                                                        ...
                                                                        <option className={'opt'} value="man">Rus
                                                                        </option>
                                                                ...
                                                                <div className="tap">
                                                                    ...
                                                                    <select className={'select form-control'} required>
                                                                        ...
                                                                        <option className={'opt'} value="sasa">Yo`q
                                                                        </option>
                                                                ...
                                                                <div className="tap">
                                                                    ...
                                                                    <select className={'select form-control'} required>
                                                                        <option className={'opt'} value="">Yo`q</option>
                                                                        <option className={'opt'} value="woman">Ha
                                                                        </option>
                                                                        <option className={'opt'} value="woman">Ha
                                                                        </option>
                                                                    </select>
                                    ...
                                    <div className="doc-btn text-center">
                                        <Link to={'/admission/adminCards/'}>
                                            <button className={'btn '}>{t('cardsTwo.btn-1')}</button>
                                        </Link>
